...
//   useLayoutEffect(() => {
//     const q = query(collection(db, newChatRoom), orderBy("createdAt", "desc"));
...
//     addDoc(collection(db, newChatRoom), {
//       _id,
//       createdAt,
//       text,
//       user,
      ...
      <Bubble
        ...
        wrapperStyle={{
          right: {
            ...
            borderBottomRightRadius: 20,
            padding: 3,
            backgroundColor: "rgb(243, 162, 95)",
          },
          left: {
            borderTopLeftRadius: 0,
            borderTopRightRadius: 20,
